...
public class ModRecipes {
    ...
    public static void addBlendRecipes() {
        GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(MachinaItems.itemBlend, 2, 0), "dustGold", "dustSilver"));
        GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(MachinaItems.itemBlend, 5, 1), "dustCopper", "dustCopper", "dustCopper", "dustCopper", "dustTin"));
        GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(MachinaItems.itemBlend, 3, 2), "dustIron", "dustIron", "dustNickel"));
        GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(MachinaItems.itemBlend, 5, 3), "dustTin", "dustTin", "dustTin", "dustLead", "dustLead"));
        GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(MachinaItems.itemBlend, 3, 4), "dustCopper", "dustCopper", "dustZinc"));
    }
    ...
    public static void addSingleIngotRecipes() {
        ...
        for (int i = 0; i < MachinaNames.itemIngotStrings.length; i++) {
            GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(MachinaItems.itemIngot, 1, i), MachinaNames.itemNuggetStrings[i], MachinaNames.itemNuggetStrings[i], MachinaNames.itemNuggetStrings[i], MachinaNames.itemNuggetStrings[i], MachinaNames.itemNuggetStrings[i], MachinaNames.itemNuggetStrings[i], MachinaNames.itemNuggetStrings[i], MachinaNames.itemNuggetStrings[i], MachinaNames.itemNuggetStrings[i]));
        }
    ...
    public static void addMetalBlockRecipes() {
        for (int i = 0; i < MachinaNames.blockMetalNames.length; i++) {
            GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(MachinaBlocks.blockMetal, 1, i), MachinaNames.itemIngotStrings[i], MachinaNames.itemIngotStrings[i], MachinaNames.itemIngotStrings[i], MachinaNames.itemIngotStrings[i], MachinaNames.itemIngotStrings[i], MachinaNames.itemIngotStrings[i], MachinaNames.itemIngotStrings[i], MachinaNames.itemIngotStrings[i], MachinaNames.itemIngotStrings[i]));
        }
    }
